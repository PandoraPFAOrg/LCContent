...
public:
   ...
   */
  static pandora::StatusCode RegisterBFieldPlugin(const pandora::Pandora& pandora, const float innerBField,
  ...
  RegisterNonLinearityEnergyCorrection(const pandora::Pandora& pandora, const std::string& name,
                                       const pandora::EnergyCorrectionType energyCorrectionType,
                                       const pandora::FloatVector& inputEnergyCorrectionPoints,
                                       const pandora::FloatVector& outputEnergyCorrectionPoints);

  /**
   *  @brief  Register the theta-energy non linearity energy correction plugin (note user side configuration) with
   * pandora
   *
   *  @param  pandora the pandora instance with which to register content
   *  @param  name the name/label associated with the energy correction plugin
   ...
   */
  static pandora::StatusCode RegisterNonLinearityEnergyCorrection(
   ...
   */
  static pandora::StatusCode
  RegisterSoftwareCompensationEnergyCorrection(const pandora::Pandora& pandora, const std::string& name,
