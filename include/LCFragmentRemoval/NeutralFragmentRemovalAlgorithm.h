...
private:
   ...
   */
  pandora::StatusCode GetClusterMergingCandidates(const NeutralClusterContactMap& neutralClusterContactMap,
   ...
   */
  pandora::StatusCode GetAffectedClusters(const NeutralClusterContactMap& neutralClusterContactMap,
