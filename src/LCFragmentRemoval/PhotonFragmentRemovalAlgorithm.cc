...
bool PhotonFragmentRemovalAlgorithm::IsCandidateParent(const Cluster *const pDaughterCluster, const Cluster *const pParentCluster) const
{
...
StatusCode PhotonFragmentRemovalAlgorithm::GetClusterMergingCandidates(const ContactMap &clusterContactMap, const Cluster *&pBestParentCluster,
