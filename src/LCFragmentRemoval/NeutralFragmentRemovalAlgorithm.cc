...
bool NeutralFragmentRemovalAlgorithm::IsCandidateParent(const Cluster *const /*pDaughterCluster*/, const Cluster *const pParentCluster) const
{
...
StatusCode NeutralFragmentRemovalAlgorithm::GetClusterMergingCandidates(const ContactMap &neutralClusterContactMap, const Cluster *&pBestParentCluster,
