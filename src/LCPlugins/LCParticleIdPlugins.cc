...
LCParticleIdPlugins::LCEmShowerId::LCEmShowerId()
    : m_mipCut_0(0.9f), m_mipCutEnergy_1(15.f), m_mipCut_1(0.3f), m_mipCutEnergy_2(7.5f), m_mipCut_2(0.4f),
      m_mipCutEnergy_3(3.f), m_mipCut_3(0.6f), m_mipCutEnergy_4(1.5f), m_mipCut_4(0.7f), m_dCosRCutEnergy(1.5f),
      m_dCosRLowECut(0.94f), m_dCosRHighECut(0.95f), m_rmsCutEnergy(40.f), m_rmsLowECut(40.f), m_rmsHighECut(90.f),
      m_minCosAngle(0.3f), m_maxInnerLayerRadLengths(10.f), m_minLayer90RadLengths(4.f), m_maxLayer90RadLengths(30.f),
      m_minShowerMaxRadLengths(0.f), m_maxShowerMaxRadLengths(25.f), m_highRadLengths(40.f),
      m_maxHighRadLengthEnergyFraction(0.04f), m_maxRadial90(40.f) {}
...
bool LCParticleIdPlugins::LCEmShowerId::IsMatch(const Cluster* const pCluster) const {
  ...
  for (unsigned int iLayer = innerPseudoLayer, outerPseudoLayer = pCluster->GetOuterPseudoLayer();
    ...
    for (CaloHitList::const_iterator hitIter = iter->second->begin(), hitIterEnd = iter->second->end();
      ...
      const float radialDistance(
          ((*hitIter)->GetPositionVector() - clusterIntercept).GetCrossProduct(clusterDirection).GetMagnitude());
  ...
  for (HitEnergyDistanceVector::const_iterator iter = hitEnergyDistanceVector.begin(),
...
StatusCode LCParticleIdPlugins::LCEmShowerId::ReadSettings(const TiXmlHandle xmlHandle) {
  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCut_0", m_mipCut_0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCutEnergy_1", m_mipCutEnergy_1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCut_1", m_mipCut_1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCutEnergy_2", m_mipCutEnergy_2));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCut_2", m_mipCut_2));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCutEnergy_3", m_mipCutEnergy_3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCut_3", m_mipCut_3));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCutEnergy_4", m_mipCutEnergy_4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MipCut_4", m_mipCut_4));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "DCosRCutEnergy", m_dCosRCutEnergy));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "DCosRLowECut", m_dCosRLowECut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "DCosRHighECut", m_dCosRHighECut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "RmsCutEnergy", m_rmsCutEnergy));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "RmsLowECut", m_rmsLowECut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "RmsHighECut", m_rmsHighECut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinCosAngle", m_minCosAngle));

  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "MaxInnerLayerRadLengths", m_maxInnerLayerRadLengths));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinLayer90RadLengths", m_minLayer90RadLengths));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxLayer90RadLengths", m_maxLayer90RadLengths));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinShowerMaxRadLengths", m_minShowerMaxRadLengths));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxShowerMaxRadLengths", m_maxShowerMaxRadLengths));
  ...
  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "MaxHighRadLengthEnergyFraction", m_maxHighRadLengthEnergyFraction));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxRadial90", m_maxRadial90));
...
StatusCode LCParticleIdPlugins::LCElectronId::ReadSettings(const TiXmlHandle xmlHandle) {
  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxInnerLayer", m_maxInnerLayer));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxEnergy", m_maxEnergy));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxProfileStart", m_maxProfileStart));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxProfileDiscrepancy", m_maxProfileDiscrepancy));

  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "ProfileDiscrepancyForAutoId", m_profileDiscrepancyForAutoId));
...
LCParticleIdPlugins::LCMuonId::LCMuonId()
    : m_maxInnerLayer(10), m_minTrackEnergy(2.5f), m_maxHCalHitEnergy(1.f), m_minECalLayers(20), m_minHCalLayers(20),
      m_shouldPerformGapCheck(true), m_minHCalLayersForGapCheck(4), m_minMuonHitsForGapCheck(3), m_eCalEnergyCut0(1.f),
      m_eCalEnergyCut1(0.05f), m_hCalEnergyCut0(5.f), m_hCalEnergyCut1(0.15f), m_minECalLayersForFit(10),
      m_minHCalLayersForFit(10), m_minMuonLayersForFit(4), m_eCalFitInnerLayer(1), m_eCalFitOuterLayer(30),
      m_hCalFitInnerLayer(31), m_hCalFitOuterLayer(79), m_eCalRmsCut0(20.f), m_eCalRmsCut1(0.2f), m_eCalMaxRmsCut(50.f),
      m_hCalRmsCut0(40.f), m_hCalRmsCut1(0.1f), m_hCalMaxRmsCut(80.f), m_eCalMipFractionCut0(0.8f),
      m_eCalMipFractionCut1(0.05f), m_eCalMaxMipFractionCut(0.6f), m_hCalMipFractionCut0(0.8f),
      m_hCalMipFractionCut1(0.02f), m_hCalMaxMipFractionCut(0.75f), m_eCalHitsPerLayerCut0(2.f),
      m_eCalHitsPerLayerCut1(0.02f), m_eCalMaxHitsPerLayerCut(5.f), m_hCalHitsPerLayerCut0(1.5f),
      m_hCalHitsPerLayerCut1(0.05f), m_hCalMaxHitsPerLayerCut(8.f), m_curlingTrackEnergy(4.f),
      m_inBarrelHitFraction(0.05f), m_tightMipFractionCut(0.85f), m_tightMipFractionECalCut(0.8f),
      m_tightMipFractionHCalCut(0.875f), m_minMuonHitsCut(2), m_minMuonTrackSegmentHitsCut(8), m_muonRmsCut(25.f),
      m_maxMuonHitsCut0(0.f), m_maxMuonHitsCut1(0.2f), m_maxMuonHitsCutMinValue(30.f) {}
...
bool LCParticleIdPlugins::LCMuonId::IsMatch(const Cluster* const pCluster) const {
  ...
  unsigned int nECalHits(0), nHCalHits(0), nMuonHits(0), nECalMipHits(0), nHCalMipHits(0), nHCalEndCapHits(0),
      nHCalBarrelHits(0);
  ...
  if ((nPseudoLayersHCal < m_minHCalLayers) && (layersHCal.size() < m_minHCalLayers)) {
    if (!m_shouldPerformGapCheck || (nPseudoLayersHCal < m_minHCalLayersForGapCheck) ||
        (nMuonHits < m_minMuonHitsForGapCheck))
      return false;

    if (!ClusterHelper::DoesClusterCrossGapRegion(this->GetPandora(), pCluster, *(pseudoLayersHCal.begin()),
                                                  *(pseudoLayersHCal.rbegin())))
      return false;
  }
  ...
  const float mipFractionECalCut(
      std::min(m_eCalMipFractionCut0 - (trackEnergy * m_eCalMipFractionCut1), m_eCalMaxMipFractionCut));

  if (mipFractionECal < mipFractionECalCut)
    nECalCutsFailed++;

  const float nHitsPerLayerECalCut(
      std::min(m_eCalHitsPerLayerCut0 + (trackEnergy * m_eCalHitsPerLayerCut1), m_eCalMaxHitsPerLayerCut));
  ...
  const bool inBarrel((nHCalEndCapHits == 0) ||
                      (static_cast<float>(nHCalBarrelHits) / static_cast<float>(nHCalBarrelHits + nHCalEndCapHits) >=
                       m_inBarrelHitFraction));
  ...
  const float mipFractionHCalCut(
      std::min(m_hCalMipFractionCut0 - (trackEnergy * m_hCalMipFractionCut1), m_hCalMaxMipFractionCut));

  if (mipFractionHCal < mipFractionHCalCut)
    nHCalCutsFailed++;

  const float nHitsPerlayerHCalCut(
      std::min(m_hCalHitsPerLayerCut0 + (trackEnergy * m_hCalHitsPerLayerCut1), m_hCalMaxHitsPerLayerCut));
...
StatusCode LCParticleIdPlugins::LCMuonId::ReadSettings(const TiXmlHandle xmlHandle) {
  ...
  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinTrackEnergy", m_minTrackEnergy));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxHCalHitEnergy", m_maxHCalHitEnergy));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinECalLayers", m_minECalLayers));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinHCalLayers", m_minHCalLayers));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ShouldPerformGapCheck", m_shouldPerformGapCheck));

  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "MinHCalLayersForGapCheck", m_minHCalLayersForGapCheck));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinMuonHitsForGapCheck", m_minMuonHitsForGapCheck));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalEnergyCut0", m_eCalEnergyCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalEnergyCut1", m_eCalEnergyCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalEnergyCut0", m_hCalEnergyCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalEnergyCut1", m_hCalEnergyCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinECalLayersForFit", m_minECalLayersForFit));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinHCalLayersForFit", m_minHCalLayersForFit));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinMuonLayersForFit", m_minMuonLayersForFit));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalFitInnerLayer", m_eCalFitInnerLayer));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalFitOuterLayer", m_eCalFitOuterLayer));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalFitInnerLayer", m_hCalFitInnerLayer));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalFitOuterLayer", m_hCalFitOuterLayer));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalRmsCut0", m_eCalRmsCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalRmsCut1", m_eCalRmsCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalMaxRmsCut", m_eCalMaxRmsCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalRmsCut0", m_hCalRmsCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalRmsCut1", m_hCalRmsCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalMaxRmsCut", m_hCalMaxRmsCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalMipFractionCut0", m_eCalMipFractionCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalMipFractionCut1", m_eCalMipFractionCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalMaxMipFractionCut", m_eCalMaxMipFractionCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalMipFractionCut0", m_hCalMipFractionCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalMipFractionCut1", m_hCalMipFractionCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalMaxMipFractionCut", m_hCalMaxMipFractionCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalHitsPerLayerCut0", m_eCalHitsPerLayerCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalHitsPerLayerCut1", m_eCalHitsPerLayerCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "ECalMaxHitsPerLayerCut", m_eCalMaxHitsPerLayerCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalHitsPerLayerCut0", m_hCalHitsPerLayerCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalHitsPerLayerCut1", m_hCalHitsPerLayerCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "HCalMaxHitsPerLayerCut", m_hCalMaxHitsPerLayerCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "CurlingTrackEnergy", m_curlingTrackEnergy));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "InBarrelHitFraction", m_inBarrelHitFraction));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "TightMipFractionCut", m_tightMipFractionCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "TightMipFractionECalCut", m_tightMipFractionECalCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "TightMipFractionHCalCut", m_tightMipFractionHCalCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MinMuonHitsCut", m_minMuonHitsCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
      XmlHelper::ReadValue(xmlHandle, "MinMuonTrackSegmentHitsCut", m_minMuonTrackSegmentHitsCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MuonRmsCut", m_muonRmsCut));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxMuonHitsCut0", m_maxMuonHitsCut0));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxMuonHitsCut1", m_maxMuonHitsCut1));

  PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS, STATUS_CODE_NOT_FOUND, !=,
                                  XmlHelper::ReadValue(xmlHandle, "MaxMuonHitsCutMinValue", m_maxMuonHitsCutMinValue));
